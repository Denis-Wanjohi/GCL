...
<div class="md:flex md:h-[50vh] mb-10">   
  <img class="md:w-1/2" src="/Images/GCL_main_logo.png" alt="">
  <div class=" md:w-1/2 text-md font-semibold   flex justify-center align-center">
