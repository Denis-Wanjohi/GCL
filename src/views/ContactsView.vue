                    ...
                    <form  class="border-b  border-gray-900/10 pb-12" @submit.prevent="userDetails">
                        ...
                        <div v-if="!isFormFilled" class="mt-10  grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3" v-if="details.service  == 'Request for internet'">
                                ...
                                <div class="mt-2">
                                    <input id="nationalIDnumber" required v-model="details.nationalID" type="number" name="national-id-number"   class="block w-full  px-4 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
